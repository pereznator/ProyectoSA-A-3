...
const {obtenerHistorialOrdenes, obtenerDetalleOrden, obtenerMontoTotalAcumulado, obtenerSeguimientoPedido} = require('../controllers/orders/orders.get.controller');
