...
const routes: Routes = [
  ...
  { path: "favoritos", component: FavoritosComponent, data: { roles: ["user"] }, canActivate: [hasPermission] },
  ...
  { path: "ordenes/:id", component: VerOrdenComponent, data: { roles: ["user", "admin"] }, canActivate: [hasPermission] },
